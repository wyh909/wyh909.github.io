			...
			var childArr = [weilingliao,yilingliao],
				...
				vm.getId= function(index,tit){
					...
					if(self.tr.size()>0 && self.tr[index]){
						return 'weixiulingliao-opt.html?id='+curTr['appointmentNum'] + '&carOwner=' + curTr['carOwner'] + '&platenumber=' + (curTr[index].platenumber||'') + orderType;
					}
